    ...
    return (
        ...
        <FormControl>
            ...
            >
                ...
                <img src={require('./img/001_Dog.JPG')} className="img-thumbnail" alt="Dog"/>
                <FormControlLabel value="2" control={<Radio />} label="Rabbit" />
                <img src={require('./img/002_Rabbit.JPG')} className="img-thumbnail" alt="Rabbit" />
                <FormControlLabel value="3" control={<Radio />} label="Owl" />
                <img src={require('./img/003_Owl.JPG')} className="img-thumbnail" alt="Owl" />
                <FormControlLabel value="4" control={<Radio />} label="Penguin" />
                <img src={require('./img/004_Penguin.JPG')} className="img-thumbnail" alt="Penguin" />
            </RadioGroup>
        </FormControl>
    );
}
                    ...
                    <form onSubmit={handleSubmit}>
                        <div className="form-group">
                            ...
                            <input value={charName} onChange={e => setCharName(e.target.value)}
                                className="form-control" id="characterName" placeholder="Character Name" />
                        </div>
